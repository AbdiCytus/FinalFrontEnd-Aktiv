                ...
                <section id="Header" class="flex flex-col gap-6">
                    <div id="Rating" class="flex items-center gap-4">
                        <div
                            ...
                            <img src="{{asset("assets/images/icons/format-circle.svg")}}" class="w-6 h-6 flex shrink-0"
                                alt="icon">
                    ...
                    <div id="Title" class="flex flex-col gap-3">
                        <h1 class="font-Neue-Plak-bold text-2xl leading-[33.6px] capitalize">Mastering the Art of Public
                            {{$workshop->name}}
                        </h1>
                        <div class="grid grid-cols-2 gap-6">
                            <div
                                ...
                                <img src="{{asset("assets/images/icons/Duration.png")}}" class="w-16 h-16 flex shrink-0"
                                    alt="icon">
                            </div>
                            <div
                                class="flex items-center justify-between rounded-2xl border border-[#E6E7EB] p-5 gap-4 bg-white">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <p class="font-semibold text-lg leading-[27px]">
                                        {{$workshop->time_at->format('M d, Y')}}</p>
                                </div>
            ...
            <section id="Sidebar" class="flex flex-col w-[420px] gap-8">
                <div class="flex flex-col rounded-3xl p-8 gap-4 bg-white">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <img src="{{asset("assets/images/icons/verify.svg")}}" class="flex w-[62px] h-[62px] shrink-0"
                            alt="icon">
                    </div>
                </div>
